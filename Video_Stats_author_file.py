"""
Script taken from the tutor's git repo. 
Source: https://github.com/MattTheDataEngineer/YT_ELT/blob/main/dags/api/video_stats.py
"""
...
def extract_video_data(video_ids):
    ...
    #base_url = f"https://youtube.googleapis.com/youtube/v3/videos?part=content
